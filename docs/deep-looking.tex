...
\caption{The gallery screen showing two artworks: \emph{Marsh Boardwalk North} by Stan Cottle and \emph{The Mouth of the Lourmarin River} by Paul Camille Guigou (1867).}
\label{fig:gallery}
\end{figure}
...
Geology & Geology & Rock formations, geological processes \\
Botany & Botany & Flora identification, ecosystems \\
Material Science & Material Sci & Pigments, paint chemistry \\
Cinematography & Cinema & Video bringing the scene to life \\
\bottomrule
\end{tabular}
\caption{The nine lens types currently available in Deep Looking.}
\label{tab:lenses}
\end{table}
...
Currently, cinematography is the only whole-image lens. It displays a video that imagines the static painting coming to life. Clicking on the video in the popup shows it in a full-screen lightbox, just like images (Figure~\ref{fig:videolb}).
...
The application currently includes two artworks, summarized in Table~\ref{tab:artworks}.
